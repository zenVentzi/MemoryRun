...
namespace ChartboostSDK {
	...
	public class Chartboost: MonoBehaviour {
		...
		///  "ClickedEnergyButton" is defined as clicking the creative interface for the interstitial.
		/// </summary>
		/// <param name="location">The location for the Chartboost impression type.</param>
		...
		///  "ClickedEnergyButton" is defined as clicking the creative interface for the "more applications".
		/// </summary>
		/// <param name="location">The location for the Chartboost impression type.</param>
		...
		///  "ClickedEnergyButton" is defined as clicking the creative interface for the rewarded video.
		/// </summary>
		/// <param name="location">The location for the Chartboost impression type.</param>
