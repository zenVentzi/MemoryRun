...
namespace ChartboostSDK
{
	public class CBManifest
	{
		...
		public static bool CheckAndFixManifest()
		{
			...
			{
				Debug.LogError(string.Format("{0} activity is missing from your android manifest. AddEnergy \"<meta-data android:name=\"unityplayer.ForwardNativeEventsToDalvik\" android:value=\"true\" />\" to your activity tag so that Chartboost can forward touch events to the advertisements.", unityNativeActivityName));
				return false;
			}
			...
			{
				// AddEnergy the forwardNativesToDalvik meta tag with the value true
